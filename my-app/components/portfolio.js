  ...
  const projects = [
    {
      ...
      title: "Project One",
      description:
        "A full-stack web application with real-time data synchronization and responsive design.",
      image:
        "https://marketplace.canva.com/EAGRieNfp1A/1/0/1600w/canva-PXaFV8BuJ_E.jpg",
    ...
    },
    {
      ...
      title: "Project Two",
      description:
        "Cross-platform mobile app with offline capabilities and push notifications.",
      image:
        "https://marketplace.canva.com/EAGRj4YKXoU/1/0/1600w/canva-09XuG9w2hJo.jpg",
    ...
    },
    {
      ...
      title: "Project Three",
      description:
        "E-commerce platform with advanced search, personalized recommendations, and secure payments.",
      image:
        "https://marketplace.canva.com/EAEvfpUVXKo/2/0/1600w/canva-TmK48CpsmJI.jpg",
        ...
        <section className="mb-20">
          ...
          <div className="space-y-8">
            {projects.map((project) => (
              <Card
                key={project.id}
                className="bg-gray-900/50 border-gray-800 overflow-hidden hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-300"
              >
          ...
          <div className="bg-gray-900/50 rounded-lg p-8 border border-gray-800 hover:shadow-lg hover:shadow-purple-500/10 transition-all duration-300">
            <div className="space-y-6 text-gray-300">
              <p>
                ...
                building modern web applications. With several years of
                experience in web development, I specialize in creating
                responsive and user-friendly interfaces using cutting-edge
                technologies.
              </p>
